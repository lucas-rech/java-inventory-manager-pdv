...
public class UserJsonTest {
    ...
    void userSerializationTest() throws IOException {
        ...
        assertThat(json.write(user)).extractingJsonPathStringValue("nickname").isEqualTo("lucasrech00");
    ...
    void userDeserializationTest() throws IOException {
        ...
        assertThat(json.parseObject(expected).nickname()).isEqualTo("lucasrech00");
